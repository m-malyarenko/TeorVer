	...
	\begin{table}[h]
		\begin{center}
			\begin{tabular}{|*{7}{c|}} \hline
				...
				\multicolumn{2}{|c|}{} & $\overline{x}$ & $med\; x$ & $z_R$ & $z_Q$ & $z_{tr}$ \\ \hline
				\multirow{2}*{$N = 10$}   & $E(z) \pm \Delta_z$ & $0 \pm 16$ & $0 \pm 48$ & $0 \pm 33$ & $0 \pm 13$ & $0 \pm 23$ \\ \cline{2-7}
	...
	\begin{table}[h]
		\begin{center}
			\begin{tabular}{|*{7}{c|}} \hline
				...
				\multicolumn{2}{|c|}{} & $\overline{x}$ & $med\; x$ & $z_R$ & $z_Q$ & $z_{tr}$ \\ \hline
				\multirow{2}*{$N = 10$}   & $E(z) \pm \Delta_z$ & $10.0 \pm 1.0$ & $9.9 \pm 2.2$ & $9.9 \pm 2.2$ & $10.0 \pm 2.1$ & $10.0 \pm 1.3$ \\ \cline{2-7}
